...
$users_url=$root_url.'/App/Views/Category/';
...
<html lang="en">
<?php 
require_once $root_url.'/App/Views/Category/header.php';
?>
...
<body class="fix-header card-no-border">
        ...
        <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Available Items Categories</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="dashboard">Home</a></li>
                        <li class="breadcrumb-item">Items Categories</li>
                    </ol>
                </div>
                <div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        if(isset($_GET['action'])){
                            ...
                            include $users_url.'load_categories.php';
                        }
                        ?>
                    </div>
                </div>
    ...
    <?php 
    require $root_url.'/App/Views/Category/scripts.php';
    ?>
</body>
