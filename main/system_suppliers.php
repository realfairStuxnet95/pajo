...
$url=$root_url.'/App/Views/Supplier/';
...
<html lang="en">
<?php 
require_once $root_url.'/App/Views/Supplier/header.php';
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Available Suppliers</h3>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        if(isset($_GET['action'])){
                            ...
                            switch ($action) {
                                case 'add_supplier':
                                    include $url.'add_supplier.php';
                                    break;
                                default:
                                    include $url.'load_suppliers.php';
                                    break;
                            }
                        }else{
                            include $url.'load_suppliers.php';
