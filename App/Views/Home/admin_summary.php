<div class="card-group">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <h2 class="m-b-0"><i class="fa fa-cubes text-info"></i></h2>
                    <h3 class="">
                        <?php 
                        echo $util->records_counter(Tables::stock()).' Items';
                        ?>
                    </h3>
                    <h6 class="card-subtitle">Available Stock</h6></div>
                <div class="col-12">
                    <div class="progress">
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <h2 class="m-b-0"><i class="fa fa-users text-success"></i></h2>
                    <h3 class="">
                        <?php 
                        echo $util->records_counter(Tables::users()).' Users';
                        ?>
                    </h3>
                    <h6 class="card-subtitle">System Users</h6></div>
            </div>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <h2 class="m-b-0"><i class="fa fa-user-o text-purple"></i></h2>
                    <h3 class="">
                        <?php 
                        echo $util->records_counter(Tables::suppliers()).' Suppliers';
                        ?>
                    </h3>
                    <h6 class="card-subtitle">Total Suppliers</h6></div>
            </div>
        </div>
    </div>
    <!-- Column -->
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    ...
                    <h3 class="">
                        <?php 
                        echo $util->records_counter(Tables::items_categories()).' Item categories';
                        ?>
                    </h3>
    ...
    <div class="col-lg-4 col-xlg-3">
        ...
        <div class="card">
            <div class="card-body bg-inverse" style="background: url(../assets/images/background/user-info.jpg) / cover;">
                <h4 class="text-white card-title">System Users</h4>
                <h6 class="card-subtitle text-white m-0 op-5">Current System Users</h6>
            </div>
            <div class="card-body">
                <div class="message-box contact-box">
                    <h2 class="add-ct-btn"><a href="users?action=add_user" class="btn btn-circle btn-lg btn-success waves-effect waves-dark">+</a></h2>
